...
function runSelfTest() {
  assert.equal(repositoryScopeViolation('AGENTS.md'), 'unapproved root file');
  ...
  assert.equal(repositoryScopeViolation('BUILT_DURING_ETHONLINE.md'), 'unapproved root file');
