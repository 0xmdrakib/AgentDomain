...
const features = [
  ...
  },
  {
    icon: ShieldCheck,
    title: 'Auto SSL & DNS',
    desc: 'Managed certificates on apex domains, with DNS configured and monitored for you.',
  },
  {
    icon: RefreshCw,
      ...
      <div className="container">
        <div className="mx-auto mb-12 max-w-2xl text-center sm:mb-16">
          <h2 className="text-balance text-3xl font-bold tracking-tight sm:text-4xl md:text-5xl">
            ...
            <br />
            <span className="gradient-text">in one checkout.</span>
          </h2>
        ...
        <div className="grid grid-cols-1 gap-4 sm:grid-cols-2 lg:grid-cols-4">
          {features.map((f) => (
            <Card
              key={f.title}
              className="interactive-surface premium-surface border-border/60 bg-card/65"
            >
              <CardContent className="p-5 sm:p-6">
                <div className="mb-4 inline-flex h-10 w-10 items-center justify-center rounded-lg border border-border/70 bg-background/60 text-primary shadow-sm">
