...
import { Plus, ExternalLink, Wallet, Loader2, ShieldCheck } from 'lucide-react';
      ...
      {!isConnected ? (
        ...
        <Card className="premium-surface">
          <CardContent className="py-12 text-center sm:py-16">
            ...
            <h2 className="font-semibold mb-2">Sign in to open your dashboard</h2>
            <p className="mx-auto mb-6 max-w-md text-sm leading-6 text-muted-foreground">
              Your agent list and management controls are private to the owner wallet.
            </p>
