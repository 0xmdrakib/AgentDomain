 ...
 *        - Backend submits the auth to USDC, USDC moves directly to the treasury.
...
contract PaymentRouter is Ownable, ReentrancyGuard, Pausable {
     ...
     * @dev USDC has ALREADY moved to treasury before this call. We only
     *      verify the backend signed off and mint. The amount field is
     *      recorded for accounting but not pulled here.
     */
